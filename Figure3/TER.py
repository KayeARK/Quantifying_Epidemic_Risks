...
Results=times
for b0 in [11,9,7,5,3,1]:
    print(b0)
    parray=matrixSIR_vary(N,k,t_max,delta_t,b0)
    parray=list(reversed(parray))
    Results=np.vstack((Results,parray))

np.savetxt("Figure3/TERk100.csv", Results, delimiter=",")
