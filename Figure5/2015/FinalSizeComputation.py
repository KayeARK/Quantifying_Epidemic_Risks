...
def N_v(t):
    return math.floor(Ha*(287.2068*(4.4397**(-((t-120.5785)**2)/8879.6)*(1+math.erf((t-120.5785)/46.1727)))))
...
def StochasticModel_mnrn(t_0,tmax,iter):
    ...
    td=-12.65781793*np.cos((2*math.pi/(365))*times+12.37433899+(2*math.pi*90/365))+13.51711126
