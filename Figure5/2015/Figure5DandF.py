...
p10=[]
p5=[]
with open("Figure5/2015/final_size2015.csv", 'r') as file:
...
plt.ylim(0,500)
plt.xlim(0,solt[-1])
plt.savefig('Figure5/2015/Figure5D.pdf', bbox_inches='tight')
plt.show()
...
plt.legend(['TER, $M=5$','TER, $M=10$','TER, $M=20$','TER, $M=50$','TER, $M=100$','CER'],fontsize=13)
plt.ylabel('Epidemic risk',fontsize=14)
plt.xlim(-10,t[-1])
plt.xticks(times,['Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec','Jan','Feb','Mar'],fontsize=13)
plt.yticks(fontsize=14)
plt.xlabel('Date of introduction (2015-16)',fontsize=14)
plt.savefig('Figure5/2015/Figure5E.pdf', bbox_inches='tight')
plt.show()